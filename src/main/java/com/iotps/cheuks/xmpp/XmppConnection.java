...
import com.iotps.cheuks.util.Constant;
...
public class XmppConnection {
	...
	public static String SERVER_HOST = Constant.URL.IP_SERVICE;//你openfire服务器所在的ip
	public static  String SERVER_NAME = Constant.URL.NAME_SERVICE;//设置openfire时的服务器名
